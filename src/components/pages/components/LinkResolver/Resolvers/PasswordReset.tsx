...
const PasswordReset: React.FC<PasswordResetProps> = (props) => {
  ...
  useEffect(() => {
    ...
    const replaceUrl = LinkResolverPaths.PasswordReset;
  ...
  const resolvedContent = () => (
    <div className="bg-grey-1 p-2" style={{ width: 500 }}>
      <form onSubmit={submitPasswordReset}>
        {infoBoxText && infoBoxText.length > 0 ? (
          <AlertBox type="info" className="mb-2" content={infoBoxText} />
        ) : null}
        ...
        <TextField
          ...
          placeholder={t(
            `${translationRootKey}.content.newPasswordPlaceholder`
          )}
          value={password}
        ...
        <TextField
          ...
          placeholder={t(
            `${translationRootKey}.content.confirmPasswordPlaceholder`
          )}
        ...
        <DialogBtn
          ...
          loading={loading}
          disabled={
            !checkPasswordMatch() || !checkPasswordRules(password) || loading
          }
        />
      </form>
    </div>
